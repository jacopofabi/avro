...
import org.apache.avro.mytests.utils.BinaryDataUtils;
...
public class BinaryDataCompareTest {
	...
	public static Collection<Object []> BufferedChannelParameters() throws Exception {
		return Arrays.asList(new Object[][] { 
			...
			{getBS(Schema.Type.FIXED, true), getBS(Schema.Type.FIXED, true), 0, 0, getS(Schema.Type.FIXED), 0 },
			{getBS(Schema.Type.ARRAY, true), getBS(Schema.Type.ARRAY, false), 1, 2, getS(Schema.Type.INT), -1},
			{getBS(Schema.Type.INT, true), getBS(Schema.Type.DOUBLE, false), 0, 0, getS(Schema.Type.ARRAY), AvroRuntimeException.class},
			
			{getBS(Schema.Type.MAP, true), getBS(Schema.Type.DOUBLE, false), 0, 0, getS(Schema.Type.BOOLEAN), 0},
			{getBS(Schema.Type.NULL, true), getBS(Schema.Type.DOUBLE, false), 0, 0, getS(Schema.Type.BYTES), NullPointerException.class},
			{getBS(Schema.Type.DOUBLE, true), getBS(Schema.Type.DOUBLE, false), 0, 0, getS(Schema.Type.DOUBLE), -1},
			{getBS(Schema.Type.ENUM, false), getBS(Schema.Type.ENUM, false), 0, 0, getS(Schema.Type.ENUM), 0},
			{getBS(Schema.Type.NULL, true), getBS(Schema.Type.DOUBLE, false), 0, 0, getS(Schema.Type.FLOAT), NullPointerException.class},
			{getBS(Schema.Type.LONG, true), getBS(Schema.Type.LONG, false), 0, 0, getS(Schema.Type.LONG), 1},
	...
	public BinaryDataCompareTest(byte[] b1, byte[] b2, int s1, int s2, Schema schema, Object result) {
		this.b1 = b1;
		this.b2 = b2;
		this.schema = schema;
		this.s1 = s1;
