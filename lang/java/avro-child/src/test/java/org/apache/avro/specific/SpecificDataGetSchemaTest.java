...
public class SpecificDataGetSchemaTest {
  ...
  public SpecificDataGetSchemaTest(java.lang.reflect.Type classType, Object result) {
  ...
  public static java.lang.reflect.Type getClassType(String classTypeString) throws NoSuchFieldException, SecurityException{
    ...
    case "map":
      attributeField = SpecificDataGetSchemaTest.class.getDeclaredField("map");
      classType = (ParameterizedType) attributeField.getGenericType();
      break;

    case "mapInt":
    attributeField = SpecificDataGetSchemaTest.class.getDeclaredField("mapInt");
    classType = (ParameterizedType) attributeField.getGenericType();
    break;

    case "array":
      attributeField = SpecificDataGetSchemaTest.class.getDeclaredField("array");
      classType = (ParameterizedType) attributeField.getGenericType();
      break;
